...
from model.srel_intra_phase2 import SREL_vary_eta
...
def main(save_weights, save_logs, save_mat, batch_size, lambda_eta, lambda_mono):
    ...
    dir_dict_saved = (
        ...
        '20241221-124227_Nstep10_batch05_sinr_15.85dB'
        )
    ...
    if save_mat:
        ...
        dir_mat_save = (
            f'mat/intra_phase2/vary_eta_vary_rho/{start_time_tag}'
    ...
    if save_weights:
        ...
        # save
        dir_weight_save = (
            f'weights/intra_phase2/vary_eta_vary_rho/{start_time_tag}'
            f'_Nstep{N_step:02d}_batch{batch_size:02d}'
            f'_sinr_{worst_sinr_avg_db:.2f}dB'
        )
...
if __name__ == "__main__":
    ...
    main(save_weights=args.save_weights, save_logs=args.save_logs,save_mat=args.save_mat, batch_size=2, lambda_eta=1e-1, lambda_mono=1e-1)
